...
| Fresh clone | Physical no-local clone, isolated venv, 274 focused and 733 full tests | [`../evidence/phase7_final/fresh_clone_environment_report.json`](../evidence/phase7_final/fresh_clone_environment_report.json) |
